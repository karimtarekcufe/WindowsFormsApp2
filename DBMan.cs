...
namespace DBapplication
{
    ...
    {
        static string DB_Connection_String = @"Data Source=LAPTOP-F54H71VG\SQLEXPRESS;Initial Catalog=weedingorganizerfinal;Integrated Security=True;Encrypt=False";
